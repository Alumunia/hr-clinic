...
<?php require('layout/logo.php');?>
	<!--THE BEGINNING ROW 3 KIRI-->
           ...
           <img src="assets/images/od.png"  class="img-responsive" style="width:540px">
			...
			<!----TEXT FIELD------>
			<div class="col-xs-5">
		   	<p style="font-size:20px" align="justify"><strong>Divisi Organization Development bertanggung jawab atas manajemen pengetahuan
			,kepemimpinan,motivasi,budaya, dan struktur organisasi, audit SDM, analisis jabatan,dll.</strong></p>
			</div>
			</div>
			<br>
			<div class="col-xs-9">
...
$statement = "`artikel` WHERE divisi='Organization Development' ORDER BY `idartikel` DESC"; // Change `records` according to your table name.
