...
<!--THE BEGINNING ROW 3 KIRI-->
           ...
           <img src="assets/images/labour.png"   style="width:210px">
			...
			<!----TEXT FIELD------>
			<div class="col-xs-5">
				<p style="font-size:20px" align="justify"><strong>Divisi Labour merupakan divisi yang membawahi bidang kompensasi,
...
$statement = "`artikel` WHERE divisi='Labour' ORDER BY `idartikel` DESC"; // Change `records` according to your table name.
