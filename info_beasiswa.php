...
$statement = "`artikel` WHERE kategori='beasiswa'  ORDER BY `idartikel` DESC"; // Change `records` according to your table name.
...
if (mysqli_num_rows($results) != 0) {
    ...
    padding-bottom: 30px;">
				...
				<h5 class="text-left"><small><span class="glyphicon glyphicon-user"></span> <?php echo $row['divisi'] ;?>  <span class="glyphicon glyphicon-time"></span>  <?php echo $row['timestamp'];?></small></h5>
